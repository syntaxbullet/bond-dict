...
const Pattern = ({pattern, meaning}) => {
    ...
    <HStack>
    <Box>
    <HStack className="pattern-wrapper" w="720px" maxW="60vw" bg={patternbg} h="16px" borderRadius="20px">
    ...
    <Text className="pattern-meaning" color="GrayText" fontSize="md" marginY={2}>{meaning}</Text>
    </Box>
    { "vibrate" in navigator &&
        <Button className="pattern-button" variantColor="blue" variant="outline" size="sm" marginLeft={2} alignSelf="flex-start" onClick={() => {
